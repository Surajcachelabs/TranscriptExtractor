...
const transcript = {
  ...
  "segments": [
    ...
    },
    {
      ...
      "text": " So you just have to give us the answer."
    },
    {
      "id": 151,
...
scoreTranscript(transcript.text).then(result => console.log(JSON.stringify(result, null, 2))).catch(console.error);